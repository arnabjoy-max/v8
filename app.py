...
# ══════════════════════════════════════════════════════════════════
    ...
    for i in range(7):
        ...
        with st.container():
            st.markdown('<div style="margin:0 12px;background:#FFFFFF;border:1.5px solid #E0E3E8;border-top:none;border-radius:0 0 12px 12px;padding:4px 14px 14px;">', unsafe_allow_html=True)
